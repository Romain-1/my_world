...
static float smoothing(sfVector2f pos, sfVector2i grid_pos, float weight[4])
{
...
float perlin(sfVector2f pos, float res, unsigned int perm[256])
{
    ...
    float weight[4] = {0};
    sfVector2f gradient[8] = {{unit, unit}, {-unit, unit},
                                {unit, -unit}, {-unit, -unit},
                                {1, 0}, {-1, 0}, {0, 1}, {0, -1}};
